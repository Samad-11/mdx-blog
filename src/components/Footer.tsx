        ...
        <div className='bg-gray-100 dark:bg-gray-800 py-10'>
            <Container>
                <footer className='grid grid-cols-1 gap-y-10 sm:grid-cols-3 gap-x-5'>
                    <div className='flex justify-between flex-col gap-y-4 col-span-1'>
                    ...
                    <div className='space-y-6 col-span-1 '>
                        ...
                        <div className='flex flex-col justify-between  h-full pb-10'>
                            ...
                            <div className='flex flex-col text-sm text-muted-foreground gap-y-2'>
                                ...
                                <Link href={'mailto:timelesstopics.online@gmail.com'} title={"Connect to me using Gmail"} rel='external' className='hover:underline w-fit'>
                                    Contact
                                </Link>
                                <Link href={'/terms-and-conditions'} title='TnC' className='hover:underline w-fit'>
                                    Terms and Conditions
                                </Link>
                                <Link href={'/privacy-policy'} title='TnC' className='hover:underline w-fit'>
                                    Privacy Policy
                                </Link>
                ...
                <footer className='pt-16 flex sm:flex-row flex-col justify-center gap-5 items-center'>
                    <div>
